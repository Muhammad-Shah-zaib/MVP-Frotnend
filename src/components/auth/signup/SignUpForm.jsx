  ...
  return (
    <form action={action} className="flex flex-col gap-5">
      <div>
        <FullnameInput
          name="fullname"
          defaultValue={values.fullname || EMPTY_STRING}
        />
        {errors.fullname && (
      ...
      <div>
        <PasswordInput name="password" defaultValue={values.password || EMPTY_STRING} />
        {errors.password && (
      ...
      <div>
        <PasswordInput name="confirmPassword" placeholder="Confirm Password" defaultValue={values.confirmPassword || EMPTY_STRING} />
